# Generated by Django 2.0.8 on 2018-10-18 06:38
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('AppMatterManager', '0006_auto_20181018_1016'),
    ]

    operations = [
        migrations.CreateModel(
            name='PrePerchaseForms',
            fields=[
        ...
        migrations.CreateModel(
            name='PrePerchaseMatterDetails',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('EF_PrePerchaseFormId', models.IntegerField(default=0)),
