...
$(function()
{
    ...
    $.ajax({
        type: "POST",
        url: "/AppMatterManager/genPerchaseMatterDetails/",
        dataType: "text",
    ...
    $("#jsGrid").jsGrid({
        ...
        controller: {
            ...
            deleteItem: function(curItem){
                return $.ajax({
                    type: "DELETE",
                    url: "/AppMatterManager/perchaseMatterDetails/" + curItem.id,
                });
            }
        },

        fields: [
            { name: "id", title: "预采购药品信息ID", type: "number", width: 80, editing: false, align:"left"},
...
function upLoadForm()
{
    //获取审核模式，并返回弹出的html
    var tmpHtml = "";
    var postData = {tableName:"PerchaseMatterDetails"};
