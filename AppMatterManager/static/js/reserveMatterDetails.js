...
{
    //删除所有临时的数据
    var postData = {tableName:"ReserveMatterDetails", fieldMethod:"EF_FormId", methodValue:0};
    $.ajax({
        type: "POST",
    ...
    $("#jsGrid").jsGrid({
        ...
        controller: {
            ...
            deleteItem: function(curItem){
                return $.ajax({
                    type: "DELETE",
                    url: "/AppMatterManager/reserveMatterDetails/" + curItem.id,
                });
            }
        },

        fields: [
            { name: "id", title: "预约药品信息ID", type: "number", width: 80, editing: false, align:"left"},
...
function upLoadForm()
{
    //获取审核模式，并返回弹出的html
    var tmpHtml = "";
    var postData = {tableName:"ReserveMatterDetails"};
