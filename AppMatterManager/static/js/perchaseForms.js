        ...
        fields: [
            ...
            },
            {
                ...
                itemTemplate: function(value, item)
                {
                    ...
                    var paraments = {};
                    paraments["curFormTableName"] = "PerchaseForms";
    ...
    $("#jsDownGrid").jsGrid({
        ...
        controller: {
            loadData: function(filter) {
                ...
                $.ajax({
                    type: "GET",
                    url: "/AppMatterManager/perchaseMatterDetails/",
                    dataType: "json",
                    data: filter
                }).done(function(result) {
                    d.resolve($.map(result, function(item) {
        ...
        fields: [
            { name: "EF_FormId", title: "预采购单ID", type: "number", width: 80, editing: false, visible:false, align:"left"},
