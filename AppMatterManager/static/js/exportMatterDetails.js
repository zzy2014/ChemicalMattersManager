...
$(function()
{
    var postData = {tableName:"ExportMatterDetails", fieldMethod:"EF_FormId", methodValue:0};
    $.ajax({
        type: "POST",
    ...
    $("#jsGrid").jsGrid({
        ...
        controller: {
            ...
            deleteItem: function(curItem){
                return $.ajax({
                    type: "DELETE",
                    url: "/AppMatterManager/exportMatterDetails/" + curItem.id,
                });
            }
        },

        fields: [
            { name: "id", title: "出库药品信息ID", type: "number", width: 80, editing: false, align:"left"},
...
{
    var tmpHtml = "";
    var postData = {tableName:"ExportMatterDetails"};
    //获取审核模式，并返回弹出的html
    $.ajax({
        type: "POST",
