    ...
    $("#jsUpGrid").jsGrid({
        ...
        controller: {
            loadData: function(filter) {
                ...
                $.ajax({
                    type: "GET",
                    url: "/AppMatterManager/exportForms/",
                    dataType: "json",
                    data: filter
                }).done(function(result) {
            ...
            deleteItem: function(curItem){
                return $.ajax({
                    type: "DELETE",
                    url: "/AppMatterManager/exportForms/" + curItem.id,
                });
            }
        },
        ...
        fields: [
            ...
            },
            {
                ...
                itemTemplate: function(value, item)
                {
                    ...
                    var paraments = {};
                    paraments["curFormTableName"] = "ExportForms";
    ...
    $("#jsDownGrid").jsGrid({
        ...
        controller: {
            loadData: function(filter) {
                ...
                $.ajax({
                    type: "GET",
                    url: "/AppMatterManager/exportMatterDetails/",
                    dataType: "json",
                    data: filter
                }).done(function(result) {
                    d.resolve($.map(result, function(item) {
        ...
        fields: [
            { name: "EF_FormId", title: "出库单ID", type: "number", width: 80, editing: false, visible:false, align:"left"},
