...
$(function()
{
    ...
    $("#jsUpGrid").jsGrid({
        ...
        rowClick: function (args)
        {
            ...
            var intFormId = args.item.id;
            ShowDownGrid(intFormId);
        },
        ...
        controller: {
            loadData: function(filter) {
                ...
                $.ajax({
                    type: "GET",
                    url: "/AppMatterManager/reserveForms/",
                    dataType: "json",
                    data: filter
                }).done(function(result) {
            ...
            deleteItem: function(curItem){
                return $.ajax({
                    type: "DELETE",
                    url: "/AppMatterManager/reserveForms/" + curItem.id,
                });
            }
        },
        ...
        fields: [
            ...
            },
            {
                ...
                itemTemplate: function(value, item)
                {
                    ...
                    var paraments = {};
                    paraments["curFormTableName"] = "ReserveForms";
                    paraments["curFormId"] = item.id;
                    paraments["curUserIndexId"] = 1;
                    ...
                    if (curcensoreState.length < 1)
                        return "";
                    else if (curcensoreState[0].id != 6)
            ...
            },
            {
                ...
                itemTemplate: function(value, item)
                {
                    ...
                    paraments["curFormTableName"] = "ReserveForms";
                    paraments["curFormId"] = item.id;
                    paraments["curUserIndexId"] = 2;
                    paraments["curCensoreUserTypeId"] = curPattern[0].EF_UserTypeId2
                    paraments["curCensoreUserId"] = item.EF_UserId2;
                    paraments["curCensoreStateId"] = item.EF_CensoreStateId2;
                    paraments["censoreStates"] = censoreStates;
                    paraments["nextUserTypeId"] = curPattern[0].EF_UserTypeId3;
            ...
            },
            {
                ...
                itemTemplate: function(value, item)
                {
                    ...
                    paraments["curFormId"] = item.id;
                    paraments["curUserIndexId"] = 1;
                    paraments["curCensoreUserTypeId"] = curPattern[0].EF_UserTypeId3;
                    paraments["curCensoreUserId"] = item.EF_UserId3;
                    paraments["curCensoreStateId"] = item.EF_CensoreStateId3;
                    paraments["censoreStates"] = censoreStates;
                    paraments["nextUserTypeId"] = 0;
...
function ShowCensoreDialog(event)
{
    ...
    $.ajax({
        type: "POST",
        url: "/AppMatterManager/showCensoreDialog/",
        dataType: "text",
        data:event.data,
        async :false,  //改为同步执行，否则不能对外部变量附值
...
//展示子表格
function ShowDownGrid(intFormId)
{
    ...
    $("#jsDownGrid").jsGrid({
        ...
        controller: {
            loadData: function(filter) {
                var d = $.Deferred();
                filter["EF_FormId"] = intFormId;

                $.ajax({
                    type: "GET",
                    url: "/AppMatterManager/reserveMatterDetails/",
                    dataType: "json",
                    data: filter
                }).done(function(result) {
                    d.resolve($.map(result, function(item) {
        ...
        fields: [
            { name: "EF_FormId", title: "预约单ID", type: "number", width: 80, editing: false, visible:false, align:"left"},
